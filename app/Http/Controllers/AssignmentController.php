...
class AssignmentController extends Controller
{
    ...
    public function edit(Assignment $assignment)
    {
        ...
        if ($assignment->isSignableDocument()) {
            $programs = Program::whereIn('id', $assignment->signableDocument->program_ids)->with(['meetings.site', 'meetings.instructors', 'meetings.location', 'contributors.organization'])->get();
        } else {
            $programs = collect();
        }
