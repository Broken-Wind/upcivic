...
class IncomingAssignmentOrganizationController extends Controller
{
    public function index(Organization $organization)
    {
        ...
        $instructors = tenant()->organization->instructors()->assignedToOrganization($organization->id)->with(['incomingAssignments.parentAssignment', 'incomingAssignments.ownFiles', 'incomingAssignments.assignedByOrganization'])->get();
