    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body">
                @if($program->canBeDeletedBy(tenant()))
                ...
                <div class="alert alert-info text-center">
                    <h4><i class="fas fa-fw fa-exclamation-triangle "></i> Cannot Cancel:</h4>
                    You cannot cancel this program because you did not propose it. Please contact {{ $program->proposing_organization->name }} to cancel it.
                </div>
