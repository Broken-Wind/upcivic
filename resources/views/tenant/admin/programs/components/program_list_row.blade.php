        ...
        <div class="row">
            ...
            <div class="col-md-1 text-right">
                @if($program['proposed_at'] == null)
                    ...
                    <button type="submit" class="btn btn-sm btn-link text-secondary" form="delete_program">
    ...
    <form action="{{ tenant()->route('tenant:admin.programs.destroy', ['program' => $program->id]) }}" method="POST" id="delete_program">
        @method('delete')
        @csrf
    </form>
