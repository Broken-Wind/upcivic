            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ tenant()->route('tenant:admin.programs.update', [$program]) }}">
                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                <button type="submit" id="delete" form="delete_program" class="btn btn-danger btn-block"  onClick="return confirm('Are you sure you want to this program? This cannot be undone.');">Delete Program</button>
                            </div>
                            <div class="col-md-8">
                                <button type="submit" id="update_program" name="update_program" class="btn btn-primary btn-block">Update Program</button>
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="publish_program" action="{{ tenant()->route('tenant:admin.programs.published.update', [$program]) }}">
                        ...
                        <div class="form-row">
                            <div class="col-md-8">
                                <button type="submit" id="update_publish_date" name="update_publish_date" class="btn btn-primary btn-block">Update Publish Date</button>
                            </div>
                            <div class="col-md-4">
                                <button type="submit" id="publish_now" name="publish_now" value="1" class="btn btn-success btn-block">Publish Now</button>
                            </div>
                        </div>
                    </form>
                </div>
