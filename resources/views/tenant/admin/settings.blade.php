...
<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="bg-light">
                <code>&lt;iframe src="{{ tenant()->route('tenant:iframe.index') }}" title="Scheduled programs" style="width: 100%; min-height: 600px; height: 100%"/&gt;</code>
            </div>
            <hr/>
            <p> Preview </p>
                <iframe style="width: 100%; min-height: 600px; height: 100%" src="{{ tenant()->route('tenant:iframe.index') }}" title="Scheduled programs"/>
            </div>
    </div>
</div>
@endsection
