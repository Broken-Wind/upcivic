<div class="modal fade" id="add-template-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            ...
            <div class="modal-body" id="modal-body">
                ...
                <form method="POST" action="{{ tenant()->route('tenant:admin.templates.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="public_notes" id="public_notes" aria-describedby="publicNotesHelp" rows="2">{{ old('public_notes') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="contributor_notes" id="contributor_notes" aria-describedby="contributorNotesHelp" rows="2">{{ old('contributor_notes') }}</textarea>
