...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">Your Plan</div>

            <div class="card-body">
                @if(!tenant()->isSubscribed())
                    <div class="jumbotron">
                        <h1 class="display-4">Upcivic Free</h1>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-4">
                                <i class="fas fa-times"></i> Document Generation & E-Signing <br/>
                                <i class="fas fa-times"></i> Instructor / Facility Management <br/>
                                <i class="fas fa-times"></i> Full Compliance Management <br/>
                                 <i class="fas fa-times"></i> One-Click Exports <br/>
                            </div>
                        </div>
                            
                        <p class="lead">
                            <a class="btn btn-primary btn-lg" href="{{ tenant()->route('tenant:admin.billing.portal') }}" role="button">Upgrade to Pro</a>
                        </p>
                ...
                @else
                    <div class="jumbotron">
                        ...
                        <p class="lead">
                            <a class="btn btn-secondary" href="#" role="button" onClick="return confirm('Are you sure you want to cancel your Pro plan?');">Cancel Pro</a>
                        </p>
